...
test('place ship horizontal', () => {
    ...
    expect(board.squares[1][2].ship.pos).toBe(0);
    expect(board.squares[1][3].ship.pos).toBe(1);
    expect(board.squares[1][4].ship.pos).toBe(2);
});
...
test('place ship vertical', () => {
    ...
    expect(board.squares[1][2].ship.pos).toBe(0);
    expect(board.squares[2][2].ship.pos).toBe(1);
    expect(board.squares[3][2].ship.pos).toBe(2);
});
